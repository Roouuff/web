  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item"><a class="nav-link" href="{{ url('fe') }}">FE</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<section id="about" class="p-5">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-9">
        <h2 class="text-center">Fakultas Ekonomi</h2>
        <hr>
        <p>
          Fakultas Ekonomi Universitas Hasyim Asy’ari (UNHASY) adalah fakultas yang berfokus pada pengembangan ilmu ekonomi dan bisnis dengan mengintegrasikan nilai-nilai keislaman."
        </p>
      </div>
    </div>
  </div>
...
<section id="prodi" class="bg-light p-5">
  <div class="container">
    <h2 class="text-center mb-4">Ilmu Ekonomi</h2>
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="card">
          <div class="card-body">
            <h5>Ekonomi</h5>
            <p>Belajar ekonomi, keuangan, dan bisnis.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="card">
          <div class="card-body">
            <h5>Manajemen</h5>
            <p>Fokus pada bisnis dan manajemen modern.</p>
          </div>
        </div>
      </div>
