  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item"><a class="nav-link" href="{{ url('ft') }}">FT</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<section id="about" class="p-5">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h2>Tentang Fakultas Teknik</h2>
        <p>
          Fakultas Teknik Universitas Hasyim Asy’ari (UNHASY) adalah fakultas yang berfokus pada pengembangan ilmu teknik dengan mengintegrasikan nilai-nilai keislaman.
        </p>
      </div>
      <div class="col-md-6">
...
<section id="prodi" class="bg-light p-5">
  <div class="container">
    <h2 class="text-center mb-4">Ilmu Teknik</h2>
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="card">
          <div class="card-body">
            <h5>Teknik Sipil</h5>
            <p>Belajar tentang konstruksi, struktur, dan teknologi bangunan.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="card">
          <div class="card-body">
            ...
            <p>Belajar tentang elektronika, sistem listrik, dan teknologi energi.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="card">
          <div class="card-body">
            <h5>Teknik Mesin</h5>
            <p>Belajar tentang desain mesin, termodinamika, dan teknologi manufacturing.</p>
          </div>
        </div>
      </div>
