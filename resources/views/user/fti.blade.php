  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item"><a class="nav-link" href="{{ url('fti') }}">FTI</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<section id="about" class="p-5">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h2>Tentang Fakultas Teknik Informatika</h2>
        <p>
          Fakultas Teknik Informatika Universitas Hasyim Asy’ari (UNHASY) adalah fakultas yang berfokus pada pengembangan ilmu teknik informatika dan teknologi informasi dengan mengintegrasikan nilai-nilai keislaman.
        </p>
      </div>
      <div class="col-md-6">
...
<section id="about" class="p-5">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-9">
        <h2 class="text-center">Fakultas Teknologi Informasi</h2>
        <hr>
        <p>
          Fakultas Teknologi Informasi Universitas Hasyim Asy’ari (UNHASY) adalah fakultas yang berfokus pada pengembangan ilmu teknologi informasi dengan mengintegrasikan nilai-nilai keislaman.
        </p>
      </div>
    </div>
  </div>
...
<section id="prodi" class="bg-light p-5">
  <div class="container">
    <h2 class="text-center mb-4">Ilmu Teknologi Informasi</h2>
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="card">
          <div class="card-body">
            ...
            <p>Belajar pemrograman, AI, dan teknologi modern.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="card">
          <div class="card-body">
            <h5>Ilmu Komputer</h5>
            <p>Belajar dasar-dasar ilmu komputer dan pemrograman.</p>
          </div>
        </div>
      </div>
